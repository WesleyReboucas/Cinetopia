...
//  Cinetopia
//
//  Created by Wesley Rebouças on 16/01/24.
//
...
class HomeViewController: UIViewController {
    ...
    private lazy var coupleImageView: UIView = {
    ...
    private lazy var welcomeLabel: UILabel  = {
        ...
        label.text = "O Lugar ideal para buscar e organizar seus filmes favoritos."
    ...
    private lazy var welcomeButton = {
        let button = UIButton()
